...
//		echo('<script> location.href = "https://support.combilift.net/wp-login.php?redirect_to=https%3A%2F%2Fsupport.combilift.net%2Felogs%2F"; </script>');
//		echo('<script> location.href = "https://support.combilift.net/login-selection"; </script>');
